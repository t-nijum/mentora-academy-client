...
const TopCourses = ({ topCoursesPromise }) => {
    ...
    return (
        <div>
            <h1 className='text-5xl text-transparent bg-clip-text bg-gradient-to-r from-[#ffcc00] to-[#ff00e4] font-bold text-center mt-5 md:mt-15'>Top Rated Courses</h1>
            ...
            <div className='text-center md:mt-10'>
                <Link to='/games'><button className=" btn my-5 text-xl text-white rounded-lg bg-gradient-to-r from-[#ffcc00] to-[#ff00e4]"> Show All Courses</button></Link>
            </div>
        </div>
    );
};
